# PYRE - Plan Your Retirement Early
...
- **Free & Private** - No login, no tracking, no ads
- **Open Source** - Transparent and community-driven
- **Flexible Modeling** - Build complex financial plans from simple math
- **Visual Analytics** - Multiple chart types to visualize your financial future
- **Shareable Plans** - Each plan gets a unique URL for easy saving and sharing
